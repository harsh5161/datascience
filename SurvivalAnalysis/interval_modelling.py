...
from Metrics import evaluate_3, evaluate_1
import time
import warnings
...
class Uni_interval:
    ...
    def kaplanMeier(self, winner=False):
        ...
        lower_pred, upper_pred = self.get_pred(model, lower_bound_t, upper_bound_t,
    ...
    def exponential(self, winner=False):
        ...
        self.resultsDict['ExponentialFitter'] = evaluate_1(upper_bound_tt, lower_pred, E_test)
    ...
    def logLogistic(self, winner=False):
        ...
        self.resultsDict['LogLogisticFitter'] = evaluate_1(upper_bound_tt, lower_pred, E_test)
    ...
    def logNormal(self, winner=False):
        ...
        self.resultsDict['LogNormalFitter'] = evaluate_1(upper_bound_tt, lower_pred, E_test)
    ...
    def generalizedGamma(self, winner=False):
        ...
        self.resultsDict['GeneralizedGammaFitter'] = evaluate_1(upper_bound_tt, lower_pred, E_test)
    ...
    def weibull(self, winner=False):
        ...
        self.resultsDict['WeibullFitter'] = evaluate_1(upper_bound_tt, lower_pred, E_test)
