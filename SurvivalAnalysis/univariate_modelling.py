...
class Uni_Modelling:
    ...
    def exponential(self, winner=False):
        ...
        yhat_tt, model = self.get_score(model, T_train, T_test, E_train)
        self.resultsDict['ExponentialFitter'] = evaluate_1(T_test, yhat_tt.drop_duplicates(keep=False,
                                                                                           inplace=True), E_test)
    ...
    def logLogistic(self, winner=False):
        ...
        yhat_tt, model = self.get_score(model, T_train, T_test, E_train)
        self.resultsDict['LogLogisticFitter'] = evaluate_1(T_test, yhat_tt.drop_duplicates(keep=False,
                                                                                           inplace=True), E_test)
    ...
    def logNormal(self, winner=False):
        ...
        yhat_tt, model = self.get_score(model, T_train, T_test, E_train)
        self.resultsDict['LogNormalFitter'] = evaluate_1(T_test, yhat_tt.drop_duplicates(keep=False,
                                                                                           inplace=True), E_test)
    ...
    def generalizedGamma(self, winner=False):
        ...
        yhat_tt, model = self.get_score(model, T_train, T_test, E_train)
        self.resultsDict['GeneralizedGammaFitter'] = evaluate_1(T_test, yhat_tt.drop_duplicates(keep=False,
                                                                                           inplace=True), E_test)
    ...
    def weibull(self, winner=False):
        ...
        yhat_tt, model = self.get_score(model, T_train, T_test, E_train)
        self.resultsDict['WeibullFitter'] = evaluate_1(T_test, yhat_tt.drop_duplicates(keep=False,
                                                                                           inplace=True), E_test)
