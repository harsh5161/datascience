...
A dashboard is created using plotly dash. It has three tabs - <br />
1. previews data table<br />
2. Numeric columns are plotted using histograms/boxplots/violinplots<br />
3. Object columns are plotted using bar charts/ pie charts<br />
All plots are univariate.<br />
...
!pip install --upgrade dash plotly sklearn   <br />
!pip install graphviz   <br />
!pip install jupyter_dash   <br />
!pip install jupyter_plotly_dash   <br />
!pip uninstall jupyter_server_proxy   <br />
!pip install jupyter_server_proxy   <br />
!jupyter serverextension enable jupyter_server_proxy  <br />
...
<br />
## Wordcloud  <br />
The top 1000 most frequent tokens(present in at least 25% of the total no. of rows, minimum 10 rows) are taken from the text engineered column and converted into a Wordcloud using the wordcloud package.<br />
<br />
<br />
