...
surv_metric1 = {'Concordance Index': _concordance_index,
                'Concordance_Index': _cindex_interval}
surv_metric2 = {'Concordance Index': simple_cindex}
surv_metric3 = {'AIC': aic}


def evaluate_2(model):
    results = {'Concordance Index': surv_metric2['Concordance Index'](model)}
    return results
...
def evaluate_1(time_events, predicted, actual):
    results = {'Concordance Index': surv_metric1['Concordance Index'](time_events, predicted, actual)}
    return results


def evaluate_1_int(time_events, predicted, actual):
    results = {'Concordance_Index': surv_metric1['Concordance_Index'](time_events, predicted, actual)}
    return results
