...
class Uni_Modelling:
    ...
    def get_score(self, model, T_train, T_test, E_train):
        ...
        return yhat_tt, surv, hazard, model
    ...
    def exponential(self, winner=False):
        ...
        yhat_tt, surv, hazard, model = self.get_score(model, T_train, T_test, E_train)
        self.resultsDict['ExponentialFitter'] = evaluate_3(model)
        self.predictionsDict['ExponentialFitter'] = [yhat_tt, surv, hazard]
    ...
    def logLogistic(self, winner=False):
        ...
        self.predictionsDict['LogLogisticFitter'] = [yhat_tt, surv, hazard]
    ...
    def logNormal(self, winner=False):
        ...
        self.predictionsDict['LogNormalFitter'] = [yhat_tt, surv, hazard]
    ...
    def generalizedGamma(self, winner=False):
        ...
        self.predictionsDict['GeneralizedGammaFitter'] = [yhat_tt, surv, hazard]
    ...
    def weibull(self, winner=False):
        ...
        self.predictionsDict['WeibullFitter'] = [yhat_tt, surv, hazard]
    ...
    def get_lead(self, model_instance):
        ...
        yhat_tt = model_instance.predict(T_test)
        surv = model_instance.survival_function_
        hazard = model_instance.hazard_

        return [yhat_tt, surv, hazard]

    def get_lead_sc(self, model_instance, T_s):
        yhat_tt = model_instance.predict(T_s)
        surv = model_instance.survival_function_
        hazard = model_instance.hazard_
